...
<html>  
        ...
        <%
          ...
          try {
                                        ...
                                        try {
                                            ...
                                            sql = "SELECT ID,USERNAME,FIRST_NAME||' '||LAST_NAME FULLNAME FROM T_USER WHERE id="+id;
                                                    
                                            
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
                                                
                                                    out.println("<tr><td>Username</td><td>: " + resultSet.getString("USERNAME") + "</td></tr>");
                                                    out.println("<tr><td>Full Name</td><td>: " + resultSet.getString("FULLNAME") + "</td></tr>");
    ...
    <form action="journal_adjust_list_upload_process.jsp" method="post" enctype="multipart/form-data">  
