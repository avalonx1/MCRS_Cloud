...
<%
    ...
    String page_base_path=request.getParameter("page_base_path");
            ...
            <%
                ...
                try {
                    ...
                    try {
                        ...
                        sql += " and (upper(name) like upper('%"+filter_itemname+"%') OR upper(value) like upper('%"+filter_itemname+"%') ) ";
                        }       
                      ...
                      <td>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/app_parameter/app_param_list_modify.jsp",
                                    ...
                                    var answer = confirm('Are You Sure want to delete form ID <%=resultSet.getString("ID")%> ?');
                                    if (answer) {
                                    $('#loading').show();
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/app_parameter/app_param_list_delete_process.jsp",
                      ...
                      <% 
                        out.println("<td> " + resultSet.getString("id") + " </td>");
                             ...
                             out.println("<td> " + resultSet.getString("value") + " </td>");
                             out.println("<td>  </td>");
