...
%>
    ...
    <script type="text/javascript">
         $(document).ready(function() {
            ...
            $("#title_box").empty();
            $("#title_box").html("<h1>Nav Tree Matrix Configuration </h1><p></p>");
            $("#title_box").show();
            ...
            $.ajax({
                    type: 'POST',
                    url: "administration/menu_navigation/tree_permission_matrix/tree_permission_matrix_list_filter.jsp",
                    data: "",
