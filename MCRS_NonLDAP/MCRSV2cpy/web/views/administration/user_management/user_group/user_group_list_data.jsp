            ...
            <%
                ...
                try {
                    ...
                    try {
                        ...
                        sql += " and (upper(group_code) like upper('%"+filter_itemname+"%') OR upper(group_name) like upper('%"+filter_itemname+"%') ) ";
                        }       
                      ...
                      <td>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/user_management/user_group/user_group_list_modify.jsp",
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/user_management/user_group/user_group_list_delete_process.jsp",
                      ...
                      <% 
                             ...
                             out.println("<td> " + resultSet.getString("group_description") + " </td>");
                             out.println("<td> " + resultSet.getString("document_pathkey") + " </td>");
                             out.println("<td> " + resultSet.getString("branch_flag") + " </td>");
