    ...
    <table class="tablewrap" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="100px">Dept Code</th>
                <th width="200px">Dept Name</th>
            ...
            <%
                ...
                try {
                    ...
                    try {
                        ...
                        sql = "select a.id id,a.dept_code, a.dept_name, a.dept_description, b.div_code||' - '||b.div_name div_id "
                              + " from t_department a left join t_division b on a.div_id=b.id where 1=1 ";
                      ...
                      <td>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/user_management/department/dept_list_modify.jsp",
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/user_management/department/dept_list_delete_process.jsp",
                      ...
                      <% 
                             ...
                             out.println("<td> " + resultSet.getString("dept_code") + " </td>");
                             out.println("<td> " + resultSet.getString("dept_name") + " </td>");
                             out.println("<td> " + resultSet.getString("dept_description") + " </td>");
                             out.println("<td> " + resultSet.getString("div_id") + " </td>");
