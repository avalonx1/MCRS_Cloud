                ...
                db.connect(1);
                    ...
                    while (resultSet.next()) {
                            if (v_userLevel.equals("1")) {
                                sql = "update T_USER set FLAG=0,CREATION_TIME=NULL where ID=" + objid + " ";
                                db.executeUpdate(sql);
                                out.println("<div class=info> deactivate User "+resultSet.getString(1).toString()+" success..</div>");
                            }else{
                                             
                                out.println("<div class=sql>You're not authorize to deactivate this items "+resultSet.getString(1).toString()+" </div>");
                            }
