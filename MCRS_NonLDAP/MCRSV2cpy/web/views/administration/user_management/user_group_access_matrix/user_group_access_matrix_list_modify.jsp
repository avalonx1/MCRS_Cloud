...
<%
 ...
 String group_master_id="";
 String group_child_id="";
                      ...
                      try {
                        ...
                        try {
                            ...
                            sql = "SELECT id,group_master_id,group_child_id "
                                 +" from v_user_group_access_matrix where id="+id;
                           ...
                           // out.println(sql);
                            ...
                            while (resultSet.next()) {
                                ...
                                group_master_id = resultSet.getString("group_master_id");
                                group_child_id = resultSet.getString("group_child_id");
...
<form id="modifyForm" method="post" action="#">
   ...
   <table class="formtable" border="0">
    ...
    <tr>
    <td width="100" align="left">Group Master</td>
    <td></td>
    <td width="100" align="left"><select id="group_master_id" name="group_master_id">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
                                                if (group_master_id.equalsIgnoreCase(resultSet.getString(1))) {
  ...
  <tr>
    <td width="100" align="left">Group Child</td>
    <td></td>
    <td width="100" align="left"><select id="group_child_id" name="group_child_id">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
                                                if (group_child_id.equalsIgnoreCase(resultSet.getString(1))) {
                                                    out.println("<option value=" + resultSet.getString(1) + " selected=selected >" + resultSet.getString(2) + "</option>");
                                                } else {
                                                    out.println("<option value=" + resultSet.getString(1) + " >" + resultSet.getString(2) + "</option>");
                                                }
...
<script type="text/javascript">
    ...
    $('#modifyForm').submit(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "administration/user_management/user_group_access_matrix/user_group_access_matrix_list_modify_process.jsp",
            data: $(this).serialize(),
            success: function (data) {
