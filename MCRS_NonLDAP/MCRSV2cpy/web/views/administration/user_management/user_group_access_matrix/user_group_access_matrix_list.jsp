...
%>
    ...
    <script type="text/javascript">
         $(document).ready(function() {
            ...
            $("#title_box").empty();
            $("#title_box").html("<h1>User Group Access Matrix List</h1><p></p>");
            $("#title_box").show();
            ...
            $.ajax({
                    type: 'POST',
                    url: "administration/user_management/user_group_access_matrix/user_group_access_matrix_list_filter.jsp",
                    data: "",
