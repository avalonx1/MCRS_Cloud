    ...
    <table class="tablewrap" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="100px">Doc Path Key</th>
                <th>Created Time</th>
                <th></th>
            </tr>
        </thead>
            ...
            <%
                ...
                try {
                    ...
                    try {
                        ...
                        sql = "select id,doc_path_key, created_time, 1 record_stat "
                              + " from "+tableName+" "
                              + " order by doc_path_key";
                      ...
                      %>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/report_management/report_pathkey/report_pathkey_list_modify.jsp",
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/report_management/report_pathkey/report_pathkey_list_recstat_process.jsp",
