        ...
        auth au = new auth(v_clientIP);
         ...
         //mulai upload
           String saveFile = new String();
            ...
            String tag_code = "DOCRPT";
            
            
            saveFile = saveFile.replace("&", "dan");
            ...
            try {
                ...
                while (resultSet.next()) {
                 ...
                 if (checkFileFormat && !reachMaxFilesize) {
                    ...
                    int idrpt = Integer.parseInt(contentValue);
                saveFile = tag_code+"_"+idrpt+"_"+saveFile;
                 
                boolean checkFileBefore = false;
                
                sql = "select id from t_report_item_file where doc_path_key='"+saveFile+"' and reportid="+idrpt+" ";
                resultSet = db.executeQuery(sql);
                ...
                if (!checkFileBefore) {
                    ...
                    try {
                        ...
                        if (ff.exists()) {
                              ...
                              sql = "insert into t_report_item_file (id,reportid,userid,doc_path_key,created_time) values "
                                + " (nextval('t_report_item_file_SEQ'),"+idrpt+","+v_userID+",'"+saveFile+"',CURRENT_TIMESTAMP)";
                    ...
                    try {
                        ...
                        out.println(e);
                                ...
                                %>
                                <script type="text/javascript">
                                    alert("File Format not match with refference data or filesize more than 100MB. Pattern File Allowed:<%=file_format%> and list extension allowed : <%=list_ext%>");
                                    window.close();
                                </script>
                                <%
                    }//end checkFileFormat
