...
<div >
            ...
            <%
                ...
                try {
                    ...
                    try {
                        ...
                        sql = "select a.id,a.reportid,a.userid,a.doc_path_key,to_char(a.created_time,'YYYY-MM-DD HH24:MI:SS') created_time,b.report_code||' - '||b.report_name RPTNAME,c.username,c.first_name||' '||c.last_name fullname "
                              + " from t_report_item_file a left join t_report_item b on a.reportid=b.id left join t_user c on a.userid=c.id "
                              + "where a.reportid="+id+" "
                     ...
                     //debug mode            
                              ...
                              if (!vStatFile) {
                               ...
                               <%   
                                ...
                                <script type="text/javascript">
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "administration/report_management/report_item/report_item_list_download_file_recstat_process.jsp",
                      ...
                      <% 
                             ...
                             out.println("<td> " + resultSet.getString("RPTNAME") + " </td>");
    ...
    <script type="text/javascript">
        ...
        $(".action_menu_wrap").css({'width':'50px'});
