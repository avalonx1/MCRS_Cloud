...
%>
    ...
    <script type="text/javascript">
         $(document).ready(function() {
            ...
            $("#title_box").empty();
            $("#title_box").html("<h1>Email Burst Role to User Group List</h1><p></p>");
            $("#title_box").show();
            ...
            $.ajax({
                    type: 'POST',
                    url: "report/emailburst_notif_usrrole_matrixgroup/emailburst_notif_usrrole_matrixgroup_list_filter.jsp",
                    data: "",
