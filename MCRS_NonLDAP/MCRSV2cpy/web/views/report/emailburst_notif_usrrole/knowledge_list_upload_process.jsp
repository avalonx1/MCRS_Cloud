           ...
           String saveFile = new String();
            ...
            try {
                ...
                while (resultSet.next()) {
                 ...
                 if (megabytes>=v_maxsizeUploadMB) {
                ...
                int jmlFileBefore = 0;
                sql = "select count(1) as jml from t_knowledge_bank_file where doc_path_key='"+saveFile+"' and knowledge_id="+idact+" ";
                resultSet = db.executeQuery(sql);
                ...
                if (!checkFileBefore) {
                        ...
                        if (ff.exists()) {
                               ...
                               sql = "insert into t_knowledge_bank_file (id,knowledge_id,user_id,doc_path_key,created_time) values "
                               + " (nextval('t_knowledge_bank_file_SEQ'),"+idact+","+v_userID+",'"+saveFile+"',CURRENT_TIMESTAMP)";
                        ...
                        jmlFileBefore++;
                         saveFile = "COPY_OF"+"_"+jmlFileBefore+"_"+saveFile;
