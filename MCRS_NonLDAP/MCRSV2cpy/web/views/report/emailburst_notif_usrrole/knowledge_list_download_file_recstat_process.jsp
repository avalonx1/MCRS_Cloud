...
<%  
    ...
    String tableName="t_knowledge_bank_file";
    ...
    String act_id = "";
        ...
        try {
            ...
            try {
                ...
                sql = "select id,knowledge_id,doc_path_key from "+tableName+" where id="+id+" ";
                resultSet = db.executeQuery(sql);
                
                while (resultSet.next()) {
                filename = resultSet.getString("doc_path_key");
                act_id = resultSet.getString("knowledge_id");
                }
...
<script type="text/javascript">
    ...
    $.ajax({
        type: 'POST',
        url: "tracking/knowledge_bank/knowledge_list_download_file.jsp",
        data: {id:<%=act_id%>},
