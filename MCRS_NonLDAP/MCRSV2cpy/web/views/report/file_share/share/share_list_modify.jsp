     ...
     String denom="999,999,999,999,999.99";
                      ...
                      try {
                        ...
                        try {
                            ...
                            sql = "SELECT a.id,a.fileid,a.userid,a.created_time,b.doc_path_key "
                                 +" from t_usr_file_share_recipient a left join t_usr_file_share b on a.fileid=b.id"
                                 +" left join t_user c on a.userid=c.id left join t_user_group d on c.group_id=d.id"
                                 +" where a.id="+id;
...
<form id="modifyForm" method="post" action="#">
   ...
   <table class="formtable" border="0">
    ...
    <tr>
    <td width="100" align="left">File to shared </td>
    <td></td>
    <td width="100" align="left"><select id="fileid" name="fileid">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            sql = "SELECT id ID, doc_path_key AS DESC "
                                                    + " FROM t_usr_file_share where userid="+v_userID+" "
                                                    + "  ORDER BY 2";
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
                                                if (fileid.equalsIgnoreCase(resultSet.getString(1))) {
  ...
  <tr>
    <td width="100" align="left">Shared to user</td>
    <td></td>
    <td width="100" align="left"><select id="userid" name="userid">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
                                                if (userid.equalsIgnoreCase(resultSet.getString(1))) {
                                                    out.println("<option value=" + resultSet.getString(1) + " selected=selected >" + resultSet.getString(2) + "</option>");
                                                } else {
                                                    out.println("<option value=" + resultSet.getString(1) + " >" + resultSet.getString(2) + "</option>");
                                                }
...
<script type="text/javascript">
    ...
    $('#modifyForm').submit(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "report/file_share/share/share_list_modify_process.jsp",
            data: $(this).serialize(),
            success: function (data) {
