           ...
           String contentType = request.getContentType();
            ...
            try {
               ...
               sql = " select case when string_agg(file_extension||' ('||case when case_sensitive=1 then 'case sensitive' else 'case insensitive' end||')',';') is null "
                ...
                sql = "select id from t_usr_file_share where doc_path_key='"+saveFile+"' and userid="+idusr+" ";
                resultSet = db.executeQuery(sql);
                ...
                if (!checkFileBefore) {
                        ...
                        sql = "insert into t_usr_file_share (id,userid,doc_path_key,created_time) values "
                            + " (nextval('t_usr_file_share_seq'),"+v_userID+",'"+saveFile+"',CURRENT_TIMESTAMP)";
