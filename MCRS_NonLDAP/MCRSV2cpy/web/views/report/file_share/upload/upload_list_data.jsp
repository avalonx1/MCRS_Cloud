             ...
             <%
                ...
                try {
                    ...
                    try {
                        ...
                        sql = "select a.id,a.userid,a.doc_path_key,to_char(a.created_time,'YYYY-MM-DD HH24:MI:SS') created_time,b.username,b.first_name||' '||b.last_name fullname, sum(case when c.id is null then 0 else 1 end) sharedcount "
                              + " from t_usr_file_share a left join t_user b on a.userid=b.id left join t_usr_file_share_recipient c on a.id=c.fileid "
                              ...
                              if (!vStatFile) {
                               ...
                               <%   
                                ...
                                <script type="text/javascript">
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "report/file_share/upload/upload_list_recstat_process.jsp",
         ...
         $(document).ready(function() {
              ...
              $('#refresh_data').click(function() {
                      ...
                      filter_itemname= document.getElementById("filter_itemname").value;
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "report/file_share/upload/upload_list_data.jsp",
                              data: {id:<%=id%>,
             ...
             $('#addRecord').click(function() {
                         ...
                         popupwindow = window.open('report/file_share/upload/upload_list_upload.jsp?id=<%=v_userID%>&stat=0','Upload File','menubar=no,location=no,resizable=no,scrollbars=no,status=yes,width=800, height=300, left=0, top=0');
                         popupWindow.focus();
                         return false;
