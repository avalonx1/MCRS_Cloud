...
<div class="tablelist_wrap">
    ...
    if (!v_currETLStatus.equals("DONE")) {
        ...
        msginfo = "<div class=alert>Please be informed that ETL (Extract-Transform-Loading) Data for Report Generation Date <b>"+v_currWorkDay+"</b> is still RUNNING.</div>";
            ...
            <%
                ...
                try {
                    ...
                    sql = "select * from ( select '"+filter_tanggal+"' report_date,a.report_id,user_group_id,user_level_id, report_code,report_name,report_extension,report_description, report_owner_name, "
                          ...
                          +" where b.record_stat=1 and b.report_id=a.report_id and '"+filter_tanggal+"'>=to_char(b.report_date_start,'"+dFormat+"') and '"+filter_tanggal+"'<=to_char(b.report_date_end,'"+dFormat+"') ) "
                          +" UNION ALL "
                          ...
                          +" where b.record_stat=1 and b.report_id=a.report_id and '"+filter_tanggal+"'>=to_char(b.report_date_start,'"+dFormat+"') and '"+filter_tanggal+"'<=to_char(b.report_date_end,'"+dFormat+"') ) ) a "
                          +" "
                          +"where 1=1 "
                          +"and report_freq_code ='MONTHLY'  "
                          ...
                          <div class="action_menu_wrap">
                              ...
                              %>
                                ...
                                <script type="text/javascript">
                                    ...
                                    window.location="<%=getPath%>/DownloadServlet?userid=<%=v_userID%>&objid=<%=resultSet.getString("report_id")%>&tglrpt=<%=filter_tanggal%>&filename=<%=vfilename%>&filenamefull=<%=vfilenamefull%>";
                                    return false;
                                    ...
                                    $.ajax({
                                        ...
                                        data: {id:<%=resultSet.getString("report_id")%>,backurl:'report/monthly/daily_report_list_data.jsp'},
                                        success: function(data) {
                                            $('#data_inner').empty();
                                            $('#data_inner').html(data);
                                            $('#data_inner').show();
         ...
         $(document).ready(function() {
               ...
               $('#refresh_data').click(function() {
                     ...
                     sorting_type =document.getElementById("sorting_type").value; 
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "report/monthly/monthly_report_list_data.jsp",
