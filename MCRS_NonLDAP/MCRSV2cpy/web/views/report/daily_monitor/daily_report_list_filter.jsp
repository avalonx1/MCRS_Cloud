...
<%
      ...
      String sorting_type = request.getParameter("sorting_type"); 
         ...
         if (filter_tanggal==null) {
             ...
             filter_tanggal=v_currWorkDay.substring(0,4)+"-"+v_currWorkDay.substring(4,6)+"-"+v_currWorkDay.substring(6,8);
         }
...
<div  class="myformfilter">
    <form  id="filter_form" method="post" action="#">
        ...
        <table >
            ...
            <tr><td>EOD Date </td><td >:<input id="filter_tanggal" type="text" name="filter_tanggal" value="<%=filter_tanggal%>" size="20" maxlength="20" /></td></tr>
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            sql = "SELECT * from (SELECT '0' ID,'-All-' AS DESC, 1 AS ORD UNION ALL SELECT distinct report_extension ID, report_extension AS DESC, 2 AS ORD "
                                                    + " FROM v_report_item where report_status=1 and freq_code IN ('WORKDAY','DAILY') ) a    "
                                                    + "  ORDER BY 3,2";
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
