                      ...
                      try {
                        ...
                        try {
                            ...
                            sql = "SELECT id,items_grouping, items_name, items2jobcat, items2group, items2type, machine_name, ip_address, "
                                    + "login_user, login_pass, source_path, source_filename, doc_status, handover_date, handover_pic, launch_date, case when sla_time is null then '' else sla_time end sla_time, "
                                    + "status_items, sys_creation_date, termination_date, act_show_time, inorder, report_day, item2groupunit,pic_user_id"
                           ...
                           //out.println(sql);
                            ...
                            pic_user_id = resultSet.getString("pic_user_id");
...
<form id="modifyForm" method="post" action="#">
  ...
  <tr>
    ...
    <td><div class="form_input_date">
            <div class="slatimerow"><input readonly=true type="text" id="sla_time" name="sla_time" size="10" maxlength="5" value="<% out.println((sla_time == null) ? "" : sla_time); %>"  /></div>
            
            <div class="sladayrow"><input type="text" id="sla_date" name="sla_date" size="10" maxlength="5" value="<% out.println((sla_time == null) ? "" : sla_time); %>"  /> Jumlah Hari </div> 
        </div></td>
    </tr>
    ...
    <tr>
    <td width="100" align="left">PIC Responsibility</td>
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="pic_user_id" name="pic_user_id">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            String sql;
                                              ...
                                              sql = "select 0 ID, '-No PIC (Adhoc)-' AS DESC, 0 AS ORD UNION ALL (select distinct a.id ID,first_name||' '||last_name AS DESC, 1 AS ORD "
                                            ...
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
                                                if (pic_user_id.equalsIgnoreCase(resultSet.getString(1))) {
                                                    out.println("<option value=" + resultSet.getString(1) + " selected=selected >" + resultSet.getString(2) + "</option>");
                                                } else {
                                                    out.println("<option value=" + resultSet.getString(1) + " >" + resultSet.getString(2) + "</option>");
                                                }
