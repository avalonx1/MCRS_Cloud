...
String SlaTargetParent = "";
 ...
 if (actionCode.equals("ADD") ) {
                        ...
                        try {
                            ...
                            String sql;
                              ...
                              sql = " select id, act_date, act2items, send_time, last_update_time, act2actstatus, act2user, "
                                      ...
                                      + "req_name, req_email, division_id, pic_main,pic_ba, pic_etl_dev, pic_rpt_dev,parent_id,leaf_stat "
                                      + "from t_act_his"
                                + "  where id="+id;
     ...
     header_title_act="Add Child Activity";
     id  = request.getParameter("id");
     ...
     try {
                        ...
                        try {
                            ...
                            String sql;
                              ...
                              sql = " select id, to_char(act_sla_target,'YYYYMMDDHH24MISS') act_sla_target "
                                      + "from t_act_his"
                                + "  where id="+id;
                           ...
                           // out.println(sql);
                            ...
                            while (resultSet.next()) {
                                ...
                                SlaTargetParent = resultSet.getString("act_sla_target");
                                
                                SLAYear = SlaTargetParent.substring(0, 4);
                                SLAMonth = SlaTargetParent.substring(4, 6);
                                SLADay = SlaTargetParent.substring(6, 8);
...
<form id="modifyForm" method="post" action="#" >
   ...
   <table class="formtable" border="0">
       ...
       <% if (actionCode.equals("ADDCHILD")) {%>
    
    <tr>
        <td width="100" align="left">Parent Activity</td>   
    <td><div class="markMandatory"></div></td>
    <td width="100" align="left"><select id="parent_id" name="parent_id" readonly="true">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                           ...
                                           sql = "SELECT ID,ACT_ITEMS_NAME AS DESC FROM T_ACT_HIS WHERE id="+id+" ";
                                           
                                            resultSet = db.executeQuery(sql);
                                            while (resultSet.next()) {
                                                if (id.equalsIgnoreCase(resultSet.getString(1))) {
  ...
  <tr><td colspan="3"> >></td></tr>
    ...
    <td>Activity Name</td>
    <td><div class="markMandatory">*</div></td>
    <td><input type="text" id="act_items_name" name="act_items_name" size="30" maxlength="100" value="<% out.println((act_items_name == null) ? "" : act_items_name); %>" /></td>
    </tr>
    
    <tr>
    <td>Additional Info</td>
    <td><div class="markMandatory">*</div></td>
    <td><textarea class="notes_info" id="addl_info" name="addl_info"  rows="10" cols="50" maxlength="4000"><% out.println((addl_info == null) ? "" : addl_info); %></textarea>
    </tr>
    
    <tr>
    <td width="100" align="left">Item Name</td>
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="act2items" name="act2items">
      <%
    ...
    <td><div class="markMandatory"></div></td>
    <td><input type="text" id="ticket_number" name="ticket_number" size="30" maxlength="50" value="<% out.println((ticket_number == null) ? "" : ticket_number); %>"  /></td>
    </tr>
    ...
    <td><div class="markMandatory">*</div></td>
    <td><input type="text" id="req_name" name="req_name" size="30" maxlength="50" value="<% out.println((req_name == null) ? "" : req_name); %>"  /></td>
    </tr>
        
     <tr>
    <td>Requestor Email</td>
    <td><div class="markMandatory">*</div></td>
    <td><input type="text" id="req_email" name="req_email" size="30" maxlength="50" value="<% out.println((req_email == null) ? "" : req_email); %>"  /></td>
    </tr>
    
   <tr>
    <td width="100" align="left">Requestor Division</td>
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="division_id" name="division_id">
      <%
  ...
  <tr>
    ...
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="act2priority" name="act2priority">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            sql = "SELECT a.ID,T_NAME FROM  T_ACTPRIORITY A where record_stat=1 "
                                                    + " ORDER BY INORDER ";
  ...
  <tr>
    ...
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="act2importance" name="act2importance">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            sql = "SELECT a.ID,T_NAME FROM  T_ACTIMPORTANCE A where record_stat=1 "
                                                    + " ORDER BY INORDER ";
  ...
  <tr>
    ...
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="act_weight" name="act_weight">
      <%
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            sql = "SELECT a.ID,T_NAME FROM  T_ACTWEIGHT A where record_stat=1 "
                                                    + " ORDER BY INORDER ";
    ...
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="pic_main" name="pic_main">
      <%
   ...
   <tr>
    ...
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="pic_ba" name="pic_ba">
      <%
   ...
   <tr>
    ...
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="pic_rpt_dev" name="pic_rpt_dev">
      <%
   ...
   <tr>
    ...
    <td><div class="markMandatory">*</div></td>
    <td width="100" align="left"><select id="pic_etl_dev" name="pic_etl_dev">
      <%
...
var dateToday = new Date();
                ...
                <% if (actionCode.equals("ADDCHILD")) { %>
                var dateSLATarget = new Date(<%=SLAYear%>,<%=SLAMonth%>-1,<%=SLADay%>);
                $("#request_datetime").datetimepicker('option', 'maxDate', dateSLATarget);
                $("#work_starttime").datetimepicker('option', 'maxDate', dateSLATarget);
                $("#act_sla_target").datetimepicker('option', 'maxDate', dateSLATarget);
                <%} %>
                
       
                
                $( "#request_datetime" ).change(function(){ 
                    
                
                var dateRequested_yyyy = $("#request_datetime").val().substr(0,4);
                var dateRequested_mm = $("#request_datetime").val().substr(5, 2);
                var dateRequested_dd = $("#request_datetime").val().substr(8, 2);
                var dateRequested_hh = $("#request_datetime").val().substr(11, 2);
                var dateRequested_min = $("#request_datetime").val().substr(14, 2);
                var dateFull=new Date(dateRequested_yyyy,dateRequested_mm-1,dateRequested_dd);
                
                $("#work_starttime").datetimepicker('option', 'minDate', dateFull);
               ...
               $( "#work_starttime" ).change(function(){ 
               
                var dateRequested_yyyy = $("#work_starttime").val().substr(0,4);
                var dateRequested_mm = $("#work_starttime").val().substr(5, 2);
                var dateRequested_dd = $("#work_starttime").val().substr(8, 2);
                var dateRequested_hh = $("#work_starttime").val().substr(11, 2);
                var dateRequested_min = $("#work_starttime").val().substr(14, 2);
                var dateFull2=new Date(dateRequested_yyyy,dateRequested_mm-1,dateRequested_dd);
                
                $("#act_sla_target").datetimepicker('option', 'minDate', dateFull2);
    ...
    $('#modifyForm').submit(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "tracking/activity/activity_list_modify_process.jsp",
            data: $(this).serialize(),
            success: function (data) {
