         ...
         //mulai upload
           String saveFile = new String();
            ...
            try {
                ...
                sql = "select id from T_ACT_HIS_DOC where doc_path_key='"+saveFile+"' and act_id="+idact+" ";
                resultSet = db.executeQuery(sql);
                ...
                if (!checkFileBefore) {
                        ...
                        if (ff.exists()) {
                               ...
                               sql = "insert into T_ACT_HIS_DOC (id,act_id,user_id,doc_path_key,created_time) values "
                               + " (nextval('T_ACT_HIS_DOC_SEQ'),"+idact+","+v_userID+",'"+saveFile+"',CURRENT_TIMESTAMP)";
